...
*/
CREATE OR REPLACE PROCEDURE {{.scratch_schema}}.page_views_this_run ()
...
BEGIN
  ...
  CALL {{.scratch_schema}}.log_model_table('{{.scratch_schema}}.page_views_this_run{{.entropy}}', 'debug', 'page_views');
END;
