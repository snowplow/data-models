...
CREATE OR REPLACE PROCEDURE {{.scratch_schema}}.page_view_engaged_time (heartbeat INT64, minimumVisitLength INT64)
...
BEGIN
	...
	CALL {{.scratch_schema}}.log_model_table('{{.scratch_schema}}.pv_engaged_time{{.entropy}}', 'trace', 'page_views');
END;
