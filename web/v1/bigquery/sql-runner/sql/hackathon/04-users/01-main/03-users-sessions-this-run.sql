...
CREATE OR REPLACE PROCEDURE {{.scratch_schema}}.users_sessions_this_run ()
...
BEGIN
  ...
  CALL {{.scratch_schema}}.log_model_table('{{.scratch_schema}}.users_sessions_this_run{{.entropy}}', 'debug', 'users');
END;
